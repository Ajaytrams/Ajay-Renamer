	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://telegram.me/Aj_creations_ajay1")],
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://youtube.com/@Aj_creations_ajay")],
                                      [InlineKeyboardButton("Support Group", url='https://telegram.me/Aj_creations_ajay'),
                                      InlineKeyboardButton("Movie Channel", url='https://telegram.me/+bKOWi483Ahc2Mjhh')],
                                      [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://p.paytm.me/xCTH/v4ohs36w')]
                                      ]))
        return
    if id:
        if old == True:
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact LazyDeveloper 🦋", url='https://telegram.me/Ajaytrams')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='https://youtube.com/@Aj_creations_ajay')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://telegram.me/Aj_creations_ajay1'),
                                                                     InlineKeyboardButton("  Support Group 🦋", url='https://telegram.me/Aj_creations_ajay')],
                                                                     [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://p.paytm.me/xCTH/v4ohs36w')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
